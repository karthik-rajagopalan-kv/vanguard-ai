...
"Guidelines:\n"
"1. FOLLOW_UP:\n"
"\t- Select this if the email requests a response that can be handled through email correspondence.\n"
...
"Response format:\n"
'Return only the label: either "FOLLOW_UP" or "SCHEDULE_A_MEETING."'
